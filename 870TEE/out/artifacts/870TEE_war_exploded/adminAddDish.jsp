...
<div class="container">
    <h2 class="sub-header">Add Dish</h2>
    <div class="col-md-3 col-md-offset-3 centered">
        <form class="form-horizontal" action="adminAdd.action">
            <div class="form-group">
                <input type="number" class="form-control" id="dishID" name="dishID" placeholder="Enter Dish Number">
            </div>
            <div class="form-group">
